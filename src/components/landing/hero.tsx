    ...
    <section id="home" className="w-full pt-20 bg-background">
      <div className="container mx-auto grid grid-cols-1 items-center gap-8 px-4 py-16 md:grid-cols-2 md:px-6 md:py-24">
        <div className="flex flex-col items-start space-y-6">
          <h1 className="font-headline text-5xl font-bold tracking-tight text-[#222] sm:text-6xl lg:text-7xl mb-6">
            Sua jornada para o <span className="text-[#FF3B30]">bem-estar mental</span> começa aqui
          </h1>
